      ...
      <div className="hero-blob" aria-hidden="true">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310 350">
          <path d="M156.4,339.5c31.8-2.5,59.4-26.8,80.2-48.5c28.3-29.5,40.5-47,56.1-85.1c14-34.3,20.7-75.6,2.3-111
            ...
            c-38.8,13.6-64,48.8-66.8,90.3c-3,43.9,17.8,88.3,33.7,128.8c5.3,13.5,10.4,27.1,14.9,40.9
            C77.5,309.9,111,343,156.4,339.5z"/>
        </svg>
      </div>

      <div className="hero-content">
        <img src={hero} alt="Tejas Mane" className="hero-avatar" />

        <div className="hero-text">
          <h1>
            Elevating Web Experiences <span className="hero-accent">Innovatively</span>
          </h1>
